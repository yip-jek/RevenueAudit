...
{
	// 基础告警管理模块
	ALMERR_INIT               = -4000001,				// 初始化出错
	ALMERR_ALARMMGR_RUN       = -4000002,				// 告警管理：任务执行出错

	// 一点稽核告警管理模块
	ALMERR_INIT_ALARM_SHOW    = -4001001,				// 初始化告警日志输出计时出错
	ALMERR_INIT_DB_CONN       = -4001002,				// 初始化数据库连接出错
	ALMERR_INIT_ALARM_FILE    = -4001003,				// 初始化告警（短信）文件出错
